...
class CustomLinter:
    ...
    def _check_import_order(self, content: str):
        ...
        try:
            ...
            stdlib_modules = {
                'os', 'sys', 'json', 're', 'ast', 'time', 'datetime', 'collections',
                'itertools', 'functools', 'operator', 'copy', 'heapq', 'bisect',
                'pathlib', 'argparse', 'logging', 'traceback', 'warnings', 'abc',
                'dataclasses', 'typing', 'enum', 'contextlib', 'urllib', 'http',
                'socket', 'ssl', 'hashlib', 'hmac', 'base64', 'binascii',
            }
            
            third_party_modules = {
                'requests', 'beautifulsoup4', 'flask', 'fastapi', 'sqlalchemy',
                'pydantic', 'numpy', 'pandas', 'scipy', 'sklearn', 'tensorflow',
                'torch', 'pytest', 'hypothesis', 'mypy', 'flake8', 'black',
            }
