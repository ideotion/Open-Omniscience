...
_FLOOD = (
    "The ministry announced sweeping new measures on Tuesday afternoon, declaring that "
...
_ORIGINAL = (
    "A retired engineer in a small mountain town has spent a decade quietly restoring "
...
def flood_corpus(monkeypatch, tmp_path):
    ...
    for i in range(40):
        ...
        s.add(
            Article(
                url=f"https://puppet{i:02d}.example/x",
                canonical_url=f"https://puppet{i:02d}.example/x",
                source_id=src.id,
                title="Reforms announced",
                content=_FLOOD,
                hash=f"flood{i}",
                language="en",
    ...
    s.add(
        Article(
            url="https://mountaingazette.example/mill",
            canonical_url="https://mountaingazette.example/mill",
            source_id=indie.id,
            title="The mill grinds again",
            content=_ORIGINAL,
            hash="indie1",
            language="en",
            published_at=now,
