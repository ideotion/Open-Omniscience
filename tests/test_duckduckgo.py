...
class TestDuckDuckGoSearch:
    ...
    def test_is_xml_content(self):
        ...
        # Test Atom tag
        assert (
            DuckDuckGoSearch._is_xml_content('<feed xmlns="http://www.w3.org/2005/Atom">') is True
        )
...
class TestSourceDiscovery:
    ...
    def test_discover_sources_by_topic(self, mock_discover, mock_search):
        ...
        sources = DuckDuckGoSearch.discover_sources_by_topic("technology news", max_sources=10)
