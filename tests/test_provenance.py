...
class TestProvenanceLedger(unittest.TestCase):
    ...
    def test_add_data_with_metadata(self):
        ...
        metadata = {"type": "document", "category": "legal"}
        provenance = self.ledger.add_data("test_id", "data", "source", metadata)
    ...
    def test_get_merkle_tree(self):
        ...
        data_items = [("id1", "data1", "source1", {}), ("id2", "data2", "source2", {})]
    ...
    def test_record_custody_change(self):
        ...
        success = self.ledger.record_custody_change("test_id", "accessed", "user123")
    ...
    def test_record_custody_change_with_new_data(self):
        ...
        success = self.ledger.record_custody_change(
            "test_id", "modified", "user456", new_data="modified data"
        )
    ...
    def test_record_custody_change_nonexistent_data(self):
        ...
        success = self.ledger.record_custody_change("nonexistent", "accessed", "user123")
    ...
    def test_get_all_merkle_trees(self):
        ...
        self.ledger.add_data_batch(
            [("id1", "data1", "source1", {}), ("id2", "data2", "source2", {})], "Batch 1"
        )

        self.ledger.add_data_batch(
            [("id3", "data3", "source3", {}), ("id4", "data4", "source4", {})], "Batch 2"
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def test_complete_workflow(self):
        ...
        self.ledger.record_custody_change(
            "doc1",
            "modified",
            "user2",
