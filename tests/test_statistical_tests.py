...
class TestStatisticalTests:
    ...
    def test_is_significant(self):
        ...
        result_significant = TestResult(
            test_name="Test", statistic=5.0, p_value=0.01, degrees_of_freedom=10
        )

        # Create a result with p-value > alpha
        result_not_significant = TestResult(
            test_name="Test", statistic=1.0, p_value=0.30, degrees_of_freedom=10
        )
    ...
    def test_summarize_results(self):
        ...
        result1 = TestResult(test_name="Test 1", statistic=2.5, p_value=0.01, degrees_of_freedom=10)
        result2 = TestResult(test_name="Test 2", statistic=1.5, p_value=0.15, degrees_of_freedom=15)
    ...
    def test_repr(self):
        ...
        result = TestResult(test_name="Test", statistic=2.5, p_value=0.01, degrees_of_freedom=10)
