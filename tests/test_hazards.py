...
_USGS = json.dumps({"features": [
    {"id": "us7000abcd", "properties": {"mag": 7.1, "place": "120km SSW of Town", "title": "M 7.1 - 120km SSW of Town",
        "time": 1_700_000_000_000, "url": "https://earthquake.usgs.gov/earthquakes/eventpage/us7000abcd"},
     "geometry": {"coordinates": [142.5, 38.1, 30.0]}},
    {"id": "us7000efgh", "properties": {"mag": 4.6, "place": "near City", "title": "M 4.6 - near City",
        "time": 1_700_100_000_000, "url": "https://earthquake.usgs.gov/x"}, "geometry": {"coordinates": [-70.0, -33.4]}},
    {"id": "bad", "properties": {"mag": 5.0}, "geometry": {"coordinates": []}},   # no coords -> skipped
]})

_GDACS = json.dumps({"features": [
    {"properties": {"eventid": 1001, "eventtype": "TC", "alertlevel": "Red", "name": "Cyclone Xyz",
        "fromdate": "2026-06-01T00:00:00", "country": "Philippines",
        "url": {"report": "https://www.gdacs.org/report?eventid=1001"}},
     "geometry": {"coordinates": [125.0, 12.0]}},
    {"properties": {"eventid": 1002, "eventtype": "FL", "alertlevel": "Orange", "name": "Floods",
        "fromdate": "2026-06-02T00:00:00", "country": "Bangladesh", "url": "https://www.gdacs.org/x"},
