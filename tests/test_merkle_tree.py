...
class TestMerkleNode(unittest.TestCase):
    ...
    def test_internal_node_hash(self):
        ...
        self.assertNotEqual(parent.hash_value, hashlib.sha256(combined.encode("utf-8")).hexdigest())
...
class TestComplexDataTypes(unittest.TestCase):
    ...
    def test_nested_data(self):
        ...
        data_list = [
            {"level1": {"level2": {"level3": ["a", "b", "c"], "level3b": {"key": "value"}}}},
            {"simple": "data"},
        ]
    ...
    def test_mixed_data_types(self):
        ...
        data_list = ["string data", 12345, {"key": "value"}, [1, 2, 3], True, None, 3.14159]
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_unicode_data(self):
        ...
        data_list = ["Hello 世界", "Привет мир", "مرحبا بالعالم", "こんにちは世界"]
    ...
    def test_binary_data(self):
        ...
        data_list = [base64.b64encode(binary_data).decode("utf-8"), "regular string"]
