...
### Output
- `dist/OpenOmniscience-0.03-x86_64.AppImage`
...
mkdir -p build-deb/open-omniscience-0.03
cp -r package/deb/debian build-deb/open-omniscience-0.03/

# Build the package
cd build-deb/open-omniscience-0.03
...
### Output
- `dist/open-omniscience_0.03_all.deb`

### Installing the .deb Package
```bash
# Install the package
sudo dpkg -i open-omniscience_0.03_all.deb
...
# Install
sudo dpkg -i dist/open-omniscience_0.03_all.deb
