...
| Reader TABS (mindmap/related/source/keywords/sentiment) | 🔶 2026-06-16 (PR1: Read·Keywords·Sentiment·Related·Links; PR1b: **Mindmap** via `/api/insights/graph?article_ids=` + `queries.article_graph` radial; self-contained reader.js SVG; tests/test_reader_tabs.py) | RC-BLOCKING (twice-repeated ask) | fork-1 (2026-06-16): the reader stays STANDALONE, NOT folded into #an. REMAINING: richer Source/WWW profile tab |
