...
| M | Keywords in the UI language: the label grammar, the three-tier ladder, auto-loaded rings at 1 / 10 s, lemmatisation, per-mention language | session (+ one operator ritual per tag) | ruled (R7, R8; Q401–Q404, Q406–Q408, Q410–Q414, Q416, Q418) · `S04-06` | **PARTIAL 2026-09-17 (PR #1148)** — the ladder, the label grammar through ONE helper, Q412's refusal, the cards, lemmatisation at extraction with `simplemma` in core, `KeywordMention.language` and the generator at 10 s. **OPEN on three things:** the consented in-app Wikidata ring job (Q406 ⛔ = b) is NOT BUILT and nothing egresses; the lemma re-normalisation job and the `reconcile_keyword_language` rewrite are carried; and no browser click-through was run, so the Q1128 = a bar is NOT met. The stoplist merge (Q1103/Q1104) stays HELD on its CONFLICT and nothing was merged into any stoplist |
