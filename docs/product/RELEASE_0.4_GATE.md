...
| N | Cross-language search through the rings in every tab; CJK segmenters; Arabic folding; the literal toggle | session | ruled (R10; Q417, Q501–Q504, Q506–Q512, Q514–Q516) · `S04-07` | **OPEN — the backend spine BUILT 2026-09-17 (PR #1149).** S1/S3/S5/S6 and Q417's server half: `resolve_concept` computed once and passed to both paths, the 40-literal cap with its switch and its anti-capping disclosure, and `search_total`'s dropped expansion hook (live-reproduced at 7 ids against a total of 3). The agreement bar is demonstrated at fixture scale — 6/6/6/6/6/6 expanded, 2/2/2/2/2/2 literal, in `docs/audit/cross-language-agreement-2026-09-17/`. REMAINING: the reader-facing half (Q502, Q504's URL state, Q508, Q509, Q512), S7 (watches, the bulletin annexe), S8 (segmenters, Arabic folding, the re-index), the real-corpus counts and Q515's cost, and the Chromium + maintainer click-through |
