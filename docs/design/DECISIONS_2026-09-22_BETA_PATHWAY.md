...
| # | item | recommend |
|---|---|---|
| **D21** | **Nothing verifies `main` itself** — the repo's entire CI protection is PR runs; the merge commit is never tested | **a — adopt a merge queue.** This branch has twice shipped green-on-PR code onto an untested merge |
