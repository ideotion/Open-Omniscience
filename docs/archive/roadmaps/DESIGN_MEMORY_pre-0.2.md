...
> [`ROADMAP.md` → "0.06 — The Intelligence Layer"](DESIGN_MEMORY_pre-0.2.md). Read both
...
is in [`ROADMAP.md` → "0.06 — The Intelligence Layer"](DESIGN_MEMORY_pre-0.2.md).
...
**Pairs with** [`ROADMAP.md`](DESIGN_MEMORY_pre-0.2.md) (the *what & why*;
