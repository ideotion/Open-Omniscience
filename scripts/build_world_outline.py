...
def main() -> int:
    ...
    ap.add_argument("--min-span", type=float, default=1.0, help="drop islands smaller than N degrees")
    ...
    print(f"  {len(out['rings'])} rings · {n_pts} points · {len(payload)/1024:.0f} KB",
          file=sys.stderr)
