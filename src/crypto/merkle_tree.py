...
class MerkleTree:
    ...
    def verify_proof(
        self, leaf_data: Any, proof: list[tuple[str, bool]], expected_root_hash: str
    ) -> bool:
        """
        ...
        data_str = (
            json.dumps(leaf_data, sort_keys=True) if not isinstance(leaf_data, str) else leaf_data
        )
    ...
    def to_dict(self) -> dict:
        ...
        return {"root_hash": self.root_hash, "num_leaves": len(self.leaves), "height": self.height}
