...
GENERIC_CCTLDS: frozenset[str] = frozenset(
    ["io", "co", "me", "ai", "tv", "cc", "gg", "ly", "fm", "sh", "to", "ws", "st", "nu", "mu", "vc", "ag", "im", "je"]
)
...
CCTLD_LANGUAGE: dict[str, str] = {
    "fr": "fr", "de": "de", "at": "de", "it": "it", "es": "es", "pt": "pt",
    "br": "pt", "ru": "ru", "ua": "uk", "by": "ru", "pl": "pl", "nl": "nl",
    "se": "sv", "no": "no", "dk": "da", "fi": "fi", "is": "is", "gr": "el",
    "cz": "cs", "sk": "sk", "hu": "hu", "ro": "ro", "bg": "bg", "hr": "hr",
    "rs": "sr", "si": "sl", "lt": "lt", "lv": "lv", "ee": "et", "tr": "tr",
    "jp": "ja", "kr": "ko", "cn": "zh", "tw": "zh", "th": "th", "vn": "vi",
    "id": "id", "ir": "fa", "il": "he", "sa": "ar", "eg": "ar", "ge": "ka",
    "am": "hy", "az": "az", "kz": "kk", "mn": "mn", "np": "ne", "lk": "si",
}
