...
DATA: the country table IS bundled (``data/dbip_country_lite.csv.gz``, ~4.5 MB,
706k IPv4+IPv6 ranges, vintage :data:`IP_GEO_AS_OF`). The official db-ip.com download is
