...
class LinkExtractor:
    ...
    def extract_links(
        self, html_content: str, base_url: str | None = None, article_id: int | None = None
    ) -> list[dict[str, Any]]:
        """
        Extract all links from HTML content.
        ...
        try:
            ...
            link_elements = soup.find_all(
                ["a", "img", "script", "link", "iframe", "source", "video", "audio"]
            )
    ...
    def _extract_link_from_element(
        self, element, base_url: str | None, article_id: int | None, position: int
    ) -> dict[str, Any] | None:
        """
    ...
    def _extract_links_with_regex(
        self, html_content: str, base_url: str | None, article_id: int | None
    ) -> list[dict[str, Any]]:
        """
