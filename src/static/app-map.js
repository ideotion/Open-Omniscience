...
*/
    ...
    // (UI-04, 2026-09-08) The standalone temporal map's UI panel was removed in slice 5b
    // and the Map tab has routed to loadOoMapCoverage ever since; loadTimemap/renderTimemap/
    // buildTmap*/showTmapDetail/showTmapWhereDetail/tmapNearby/the onTmap*+zoom/reset/play/
    // mentions handlers/wireTmap*/tmap*Prefs/the TMAP state null-guarded on the removed
    // #tmap-* elements and had zero live callers (loadTimemap's only caller was itself) —
    // deleted. kindColor/TMAP_KINDS/kindLabel (above) and MON/fmtYear/fmtDate/TMAP_NEAR_DEG/
    // tmapFindCoverage (this block) are the helpers ooMap's live code genuinely still calls
    // and stay; dateToT/TMAP_SPAN_OVERRIDE, which the prior version of this comment also
    // named as shared, had no live caller either on a fresh grep and were deleted with the
    // rest of the cluster.
